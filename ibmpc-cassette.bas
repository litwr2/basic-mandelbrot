...
14 n%=30
15 SCREEN 1:KEY OFF:DEF SEG=64:GOSUB 40:ts=t2
...
29 LOCATE 2,2:ts=(t1-ts)/18.2065:t1=INT(ts/3600):t2=INT((ts-t1*3600)/60):PRINT t1;t2;ts-t1*3600-t2*60
30 a$=INKEY$:IF a$="" THEN 30
31 END
40 t1=PEEK(&h6c)+PEEK(&h6d)*256+PEEK(&h6e)*65536+PEEK(&h6f)*256*65536
41 t2=PEEK(&h6c)+PEEK(&h6d)*256+PEEK(&h6e)*65536+PEEK(&h6f)*256*65536
